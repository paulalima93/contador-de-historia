  ...
  render() {
    ...
    if (!this.state.fontsLoaded) {
      ...
      return (
        ...
        onPress={()=> this.props.navigation.navigate("Tela de História", {story: this.props.story})}>
             <View style={this.state.light_theme ? styles.cardContainerLight: styles.cardContainer}>
                <Image source={images[story.preview_image]} style={styles.storyImage}></Image>
            ...
            <View style={styles.likeButton}>
                ...
                <Text style={this.state.light_theme ? styles.likeTextLight: styles.likeText}>1k</Text>
              </View>
            </View>
        </View>
