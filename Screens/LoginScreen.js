...
import { StyleSheet, View, TouchableOpacity,Text, Image, Platform, StatusBar, Dimensions, SafeAreaView } from "react-native";
  ...
  signInWithGoogleAsync = async () => {
    try {
      const result = await Google.logInAsync({
        behaviour: "web",
        androidClientId:
          "1004706351574-jtqo2k71ts1oojq68rs30fu9o8kuvq06.apps.googleusercontent.com",
        iosClientId:
      ...
      <View style={styles.container}>
       ...
       <View style={styles.appTitle}>
        ...
        onPress = {()=> this.signInWithGoogleAsync()}>
          ...
          <Text style={styles.googleText}>Realizar o Login com o Google</Text>
